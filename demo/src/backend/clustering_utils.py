...
def process_enroll_data(enroll_folder_path, test_folder_path):
    ...
    # Previously I tried combining cluster with test set, but I realise it worked better 
    # with just the files from Demo. So now we have Demo folder combine with demo folder cos I lazy change
